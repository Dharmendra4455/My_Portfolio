...
const Nav = () => {
 ...
 useEffect(()=>{
  ...
  return (
    ...
    <div className=' flex justify-between  sm:hidden h-14 w-640 font-bold text-xl text-white'>
   ...
   <div className=' h-16 hidden sm:flex sm:items-center justify-between w-full   font-bold text-xl  bg-#0a0a0a text-white'>
